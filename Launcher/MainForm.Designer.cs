...
namespace Launcher
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtFieldHeight.Text = rnd.Next(25,50).ToString();
            ...
            this.txtFieldWidth.Text = rnd.Next(25,50).ToString();
            ...
            this.txtTerrainDomainNumber.Text = "8";
